...
public class KawaseBlur {
    ...
    public void updateBlur(float offset, int steps) {
        ...
        ShaderUtils.kawaseDown.attach();
        ShaderUtils.kawaseDown.setUniform("offset", offset);
        ShaderUtils.kawaseDown.setUniformf("resolution", 1f / mc.getMainWindow().getWidth(),
        ...
        ShaderUtils.kawaseUp.attach();
        ShaderUtils.kawaseUp.setUniform("offset", offset);
        ShaderUtils.kawaseUp.setUniformf("resolution", 1f / mc.getMainWindow().getWidth(),
                1f / mc.getMainWindow().getHeight());
