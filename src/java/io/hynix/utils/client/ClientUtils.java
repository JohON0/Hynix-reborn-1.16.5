...
public class ClientUtils implements IMinecraft {
    ...
    public static void startRPC() {
        ...
        discordRPC.Discord_Initialize("1303746843636793384", eventHandlers, true, null);
        discordRichPresence.startTimestamp = System.currentTimeMillis() / 1000L;
        discordRichPresence.largeImageText = "Билд: " + HynixMain.version + " | Джохон и Лир лучшие!";
        ...
        public static int getFTAn() {
            ...
            try {
                ...
                for (ScoreObjective team : mc.world.getScoreboard().getScoreObjectives()) {
                    ScorePlayerTeam scoreplayerteam = mc.world.getScoreboard().getPlayersTeam(team.getName());
                    String s1 = ScorePlayerTeam.getTitle(scoreplayerteam, team.getDisplayName()).getString();

                    if (s1.contains("Анархия-")) {
                        String board = s1.split("Анархия-")[1];
