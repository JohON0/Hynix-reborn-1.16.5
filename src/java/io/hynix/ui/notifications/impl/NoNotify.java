...
public class NoNotify extends Notification {
    ...
    public void render(MatrixStack matrixStack, int multiplierY) {
        ...
        ClientFonts.icons_wex[iconSizeF].drawString(matrixStack, "I", posX - (iconSize - 2.5), posY - height / 2 + ClientFonts.icons_wex[iconSizeF].getFontHeight() - margin / 2 + 2.5f, ColorUtils.reAlphaInt(ClickGui.textcolor, (int) (255 * alphaValue)));
        ClientFonts.tenacityBold[fontSize].drawString(matrixStack, getContent(), posX + margin, posY + margin / 2F + 2.5f, ColorUtils.reAlphaInt(ClickGui.textcolor, (int) (255 * alphaValue)));
    }
