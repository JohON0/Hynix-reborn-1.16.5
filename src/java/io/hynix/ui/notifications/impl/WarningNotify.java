...
public class WarningNotify extends NoNotify {
    ...
    public void render(MatrixStack matrixStack, int multiplierY) {
        ...
        ClientFonts.icons_wex[iconSizeF].drawString(matrixStack, "L", posX - (iconSize - 2.5), posY - height / 2 + ClientFonts.icons_wex[iconSizeF].getFontHeight() - margin / 2 + 1, ColorUtils.reAlphaInt(ClickGui.textcolor, (int) (255 * alphaValue)));
