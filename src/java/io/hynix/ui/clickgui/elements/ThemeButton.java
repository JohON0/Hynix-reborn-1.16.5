...
public class ThemeButton {
    ...
    public ThemeButton(int x, int y, int width, int height, String placeholder) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        ClientFonts.tenacityBold[15].drawString(matrixStack, ClickGui.themelightofdark ? "Светлая" : "Темная", x + ClientFonts.icons_wex[25].getWidth("B") + 5 + posAnimation, y + (height - 8f) / 2 + 1.5f, ColorUtils.reAlphaInt(ClickGui.textcolor, (int) (255 * animation)));
    }
}