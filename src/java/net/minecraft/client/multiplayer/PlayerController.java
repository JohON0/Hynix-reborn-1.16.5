...
public class PlayerController {
     ...
     * @return
     */
    public boolean attackEntity(PlayerEntity playerIn, Entity targetEntity) {
    ...
    public void windowClick(int containerId, int slot, int hotbarSlot, int i, ClientPlayerEntity player) {
