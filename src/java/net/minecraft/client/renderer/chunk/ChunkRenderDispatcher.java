...
public class ChunkRenderDispatcher
{
    ...
    public class ChunkRender implements IForgeRenderChunk
    {
        ...
        public float animation = 1; // anim = Math.min(ThreadLocalRandom.current().nextInt(150), 100)
        @Nullable
        ...
        class SortTransparencyTask extends ChunkRenderTask
        {
            ...
            public SortTransparencyTask(ChunkPos p_i242103_2_, double p_i242103_3_, CompiledChunk p_i242103_5_)
            {
