...
public abstract class AbstractSlider extends Widget
{
    ...
    protected void renderBg(MatrixStack matrixStack, Minecraft minecraft, int mouseX, int mouseY)
    {
        if (Unhook.unhooked) {
            ...
            int slidercolor = ColorUtils.rgba(45, 45, 45, 255);
            RenderUtils.drawRoundedRect(this.x + 3, this.y + 3, (float) (this.sliderValue * (double) (this.width - 6)), 20 - 6, 2, ColorUtils.setAlpha(slidercolor, 80));
        }
    }
