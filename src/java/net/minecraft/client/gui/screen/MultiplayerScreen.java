...
//    private final VersionSelectScreen viaScreen = HynixMain.getInstance().getViaMCP().getViaScreen();
...
//            addButton(HynixMain.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
//        HynixMain.getInstance().getViaMCP().viaScreen.tick();
