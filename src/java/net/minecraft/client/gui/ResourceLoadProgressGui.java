...
import io.hynix.utils.johon0.render.other.GaussianBloom;
...
public class ResourceLoadProgressGui extends LoadingGui {
    ...
    private BetterText text = new BetterText(Arrays.asList("...","...","..."), 500);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (f >= 1.0F) {
            ...
            int l = MathHelper.ceil((1.0F - MathHelper.clamp(f - 1.0F, 0.0F, 1.0F)) * 255.0F);
            RenderUtils.drawRoundedRect(0, 0, width, height, 0, ColorUtils.rgba(5, 5, 5, l));
            f2 = 1.0F - MathHelper.clamp(f - 1.0F, 0.0F, 1.0F);
        ...
        RenderUtils.drawRoundedRect(0, 0, width, height, 0, ColorUtils.rgba(5, 5, 5, (int) (255 * f2)));
        float percent = (float) (Math.round(progress * 1000F)) /10;
        ClientFonts.tenacityBold[20].drawCenteredString(matrixStack, "Hynix Loading" + text.output, width / 2f, height / 2f + 50, ColorUtils.rgba(255, 255, 255, (int) (255 * f2)));
        ClientFonts.tenacityBold[20].drawCenteredString(matrixStack, "Telegram: " + "@hynixclient", width / 2f, height - 20, ColorUtils.rgba(255, 255, 255, (int) (255 * f2)));
        ClientFonts.tenacityBold[18].drawCenteredString(matrixStack, percent + "%", width / 2f, height / 2f + 65, ColorUtils.rgba(255, 255, 255, (int) (255 * f2)));

        float finalF = f2;
        GaussianBloom.GUI.registerRenderCall(() -> {

            ClientFonts.tenacityBold[20].drawCenteredString(matrixStack, "Hynix Loading" + text.output, width / 2f, height / 2f + 50, ColorUtils.rgba(255, 255, 255, (int) (255 * finalF)));
            ClientFonts.tenacityBold[20].drawCenteredString(matrixStack, "Telegram: " + "@hynixclient", width / 2f, height - 20, ColorUtils.rgba(255, 255, 255, (int) (255 * finalF)));
            ClientFonts.tenacityBold[18].drawCenteredString(matrixStack, percent + "%", width / 2f, height / 2f + 65, ColorUtils.rgba(255, 255, 255, (int) (255 * finalF)));
        });

        GaussianBloom.GUI.draw(10, 1, false, 1);
