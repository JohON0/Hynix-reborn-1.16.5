...
public class PlayerTabOverlayGui extends AbstractGui {
    ...
    public void setVisible(boolean visible) {
        ...
        this.animation.animate(Unhook.unhooked ? 10.0 : (visible && isBetter ? 10.0 : -400.0), Unhook.unhooked || !isBetter ? 0.0 : 0.35, visible && isBetter ? Easings.EXPO_OUT : Easings.EXPO_IN, true);
    }
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        ...
        for (int i5 = 0; i5 < i4; ++i5) {
            ...
            if (Unhook.unhooked) {
                ...
                boolean isPlayer = this.getDisplayName(list.get(i5)).getString().contains(this.mc.player.getNameClear()) || HynixMain.getInstance().getModuleManager().getNameProtect().isEnabled() && this.getDisplayName(list.get(i5)).getString().equalsIgnoreCase("Venus");
                for (Friend friend : FriendManager.getFriends()) {
                    ...
                    PlayerTabOverlayGui.fill(p_238523_1_, k2, l2, k2 + i1, l2 + 8, ColorUtils.rgb(0, 200, 0));
                }
                if (isPlayer) {
                    PlayerTabOverlayGui.fill(p_238523_1_, k2, l2, k2 + i1, l2 + 8, ColorUtils.rgba(47, 142, 230, 170));
                } else {
                    PlayerTabOverlayGui.fill(p_238523_1_, k2, l2, k2 + i1, l2 + 8, n);
                }
            }
            ...
            if (i5 < list.size()) {
                ...
                if (isBetter) {
                    ...
                    float textWidth = ClientFonts.tenacityBold[12].getWidth(String.valueOf(ping));
                    ...
                    ClientFonts.tenacityBold[12].drawStringWithOutline(p_238523_1_, String.valueOf(ping), i1 + k2 - (flag ? 9 : 0) - textWidth - 2, l2 + 3.5f, color);
                } else {
