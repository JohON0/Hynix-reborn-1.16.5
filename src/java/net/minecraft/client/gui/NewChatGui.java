        ...
        if (!this.func_238496_i_())
        {
            ...
            if (k > 0)
            {
                ...
                for (int j1 = 0; j1 + this.scrollPos < this.drawnChatLines.size() && j1 < j; ++j1) {
                    ...
                    BetterMinecraft better = HynixMain.getInstance().getModuleManager().getBetterMinecraft();
                    boolean isBetter = better.isEnabled() && better.betterChat.getValue();
                    if (isBetter && !Unhook.unhooked) {
                    ...
                    } else if (HynixMain.getInstance().getModuleManager().getBetterMinecraft().smoothChat.getValue()) {
