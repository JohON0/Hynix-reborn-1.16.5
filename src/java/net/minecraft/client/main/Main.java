...
import io.hynix.managers.checking.version.check.CheckVersion;
import io.hynix.managers.checking.version.ui.Window;
...
import static io.hynix.HynixMain.version;

public class Main {
    private static final Logger LOGGER = LogManager.getLogger();

    public static void main(String[] p_main_0_) {
//        if (!Objects.equals(CheckVersion.checkVersion(), version)) {
//            Window.window();
//        }
        ...
        OptionSpec<String> optionspec10 = optionparser.accepts("username").withRequiredArg().defaultsTo("hynix_random_" + Util.milliTime() % 1000L);
        ...
        Thread thread = new Thread("Client Shutdown Thread") {
            public void run() {
                ...
                HynixMain.getInstance().clientShotdown();
                if (minecraft1 != null) {
