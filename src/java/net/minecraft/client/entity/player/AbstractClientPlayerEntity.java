...
import io.hynix.waveycapes.CapeHolder;
...
public abstract class AbstractClientPlayerEntity extends PlayerEntity implements CapeHolder
{
    ...
    public float arrow_cos,arrow_sin,arrow_anim;
    private static final ResourceLocation TEXTURE_ELYTRA = new ResourceLocation("textures/entity/elytra.png");

    public CapeHolder capeHolder;
    ...
    public boolean hasCustomCape() {
        return this instanceof ClientPlayerEntity || (HynixMain.getInstance().getFriendManager().isFriend(this.getNameClear()));
    }
    ...
    public ResourceLocation getLocationCape()
    {
        ...
        if (this instanceof ClientPlayerEntity && !Unhook.unhooked) {
            return new ResourceLocation(cape);
//            return CustomCape.location;
        }
