...
import io.hynix.command.interfaces.CommandDispatcher;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void tick() {
        if (this.world.isBlockLoaded(new BlockPos(this.getPosX(), 0.0D, this.getPosZ()))) {
            if (!HynixMain.getInstance().playerOnServer) {
                HynixMain.getInstance().playerOnServer = true;
            }

            HynixMain.getInstance().getEventBus().post(eventUpdate);
            super.tick();
    ...
    private void onUpdateWalkingPlayer() {
        ...
        HynixMain.getInstance().getEventBus().post(ea);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            HynixMain.getInstance().getEventBus().post(eventMotion);
        ...
        HynixMain.getInstance().getEventBus().post(new EventPostMotion());
    ...
    public void sendChatMessage(String message) {
        ...
        CommandDispatcher commandDispatcher = HynixMain.getInstance().getCommandDispatcher();
    ...
    public void closeScreen() {
        ...
        HynixMain.getInstance().getEventBus().post(event);
        if (!event.isCancel()) {
    ...
    public void setSprinting(boolean sprinting) {
        HynixMain.getInstance().getEventBus().post(eventSprint);
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            HynixMain.getInstance().getEventBus().post(eventNoSlow);
    ...
    public static class WindowClickMemory {
        ...
        public TimerUtils timerWaitAction = new TimerUtils();
    ...
    StickSimulation simulation = new StickSimulation();
