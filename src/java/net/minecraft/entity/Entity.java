...
import io.hynix.events.impl.EventStartRiding;
import io.hynix.events.impl.EventMoving;
import io.hynix.events.impl.EventPostMove;
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                HynixMain.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                HynixMain.getInstance().getEventBus().post(post);
            }
...
//    	}
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        HynixMain.getInstance().getEventBus().post(new EventStartRiding(entityIn));
    ...
    public float getCollisionBorderSize() {
        ...
        HitBox entityBox = moduleManager.getEntityBox();
