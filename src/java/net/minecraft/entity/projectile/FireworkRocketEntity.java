        ...
        if (this.isAttachedToEntity())
        {
            ...
            if (this.boostedEntity != null) {
                if (this.boostedEntity.isElytraFlying()) {
                    ...
                    if (hitAura.isEnabled() && hitAura.target != null && hitAura.options.is("Коррекция движения").getValue() && boostedEntity instanceof ClientPlayerEntity) {
                        Vector3d vector3d = this.getVectorForRotation(hitAura.rotateVector.y, hitAura.rotateVector.x);
